    ...
    <div className='w-full'>
      ...
      <div className='px-[60px] mt-[6px]'>
        <div className='h-[78px] py-[14px] gap-4 flex max-w-full'>
          <div className={`min-w-[100px] gap-5 cursor-pointer relative w-auto h-[50px] justify-between rounded-[15px] flex items-center bg-bgMode transition-all text-textMode px-5`} onClick={() => setUsersStatus("USERS")}>
            <img src={userss} alt="article"/>
            <p>USERS</p>
            <p>{users.length}</p>
          </div>
          <div className={`min-w-[100px] gap-5 cursor-pointer relative w-auto h-[50px] justify-between rounded-[15px] flex items-center bg-bgMode transition-all text-textMode px-5`} onClick={() => setUsersStatus("BLOCKED USERS")}>
