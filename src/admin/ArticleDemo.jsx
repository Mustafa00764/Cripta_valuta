...
const ArticleDemo = () => {
  ...
  const {image,main,categorie,pubDate,titled,subtitled,conclusione} = useContext(AdminContext)
  const goBack = () => {
    navigate(-1);
  };
  ...
  return (
    <div className="articleInfo">
      <div className="infoContainer">
        ...
        <div className="w-full bg-bgMode rounded-[15px] md:rounded-none h-auto relative overflow-hidden ">
          <div className=" relative">
            <div
              className="h-[408px] ms:h-[344px] w-full absolute  top-0 overflow-hidden left-0 bg-no-repeat bg-cover bg-center"
              style={{ backgroundImage: `url(${image})` }}
            >
              <div className=" backdrop-blur-2xl w-full h-[110%] bg-blurMode "></div>
            </div>
            <div className="px-[64px] xl:px-[48px] md:px-6 md:pt-4 xl:pt-[66px] flex xm:flex-col-reverse gap-8 pt-[88px] relative">
              <div>
                ...
                <div className="hidden flex-col text-textMode gap-2 xm:flex mt-[32px]">
              ...
              <div className="h-[416px] xm:h-auto xm:w-[100%] w-[571px] text-textMode flex flex-col justify-between xm:pt-0 pt-[40px]">
                <div className="flex flex-col xm:flex-col-reverse gap-4">
                  ...
                  <div>
                    <p className="text-[36px] break-all font-semibold leading-[48px] mx:text-[22px] ms:text-[18px] mx:leading-[28px] ms:leading-[24px] sm:text-[28px] sm:leading-[36px] xm:text-[36px] xm:leading-[48px] 2xl:text-[32px] 2xl:leading-[40px]">
                      {titled}
                    </p>
                  </div>
                ...
                <div className="flex flex-col gap-2 xm:hidden">
                  <p className="text-[14px] leading-6">Поделиться:</p>
                  <div className="flex gap-2 items-center">
                    <div className="p-1 rounded-[10px] bg-pageMode cursor-pointer transition-all shareIcon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="pl-16 pr-4 pt-[88px] md:pt-[45px] sm:pt-[40px] text-textMode lg:px-[48px] md:px-6 pb-[88px] gap-8 flex h-full relative">
            <div className="w-[65%] lg:w-full mx:text-[14px]">
              <div>
                <p className="break-all leading-6 mt-8 pr-5 font-normal">
                  {subtitled}
                </p>
              </div>
              <div className="w-full mt-8 text-wrap break-all">
              <div className="main" dangerouslySetInnerHTML={{ __html: main }} />
              </div>
              <div>
                <p>
                {conclusione}
            ...
            <div className="w-[32.5%] lg:hidden border relative border-pageMode py-[56px] xl:py-[48px] xl:px-9  xm:py-8 xm:px-6 px-[40px] rounded-[10px] flex flex-col gap-8">
              <div>
                <CryptoChart />
              </div>
              <div>
