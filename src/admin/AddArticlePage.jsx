        ...
        <form onSubmit={sendToBackend}>
          ...
          <div className={`w-full max-w-[1280px] `}>
            <div className={`border flex flex-wrap gap-1 border-b-0 cursor-pointer h-auto border-[#262E34] ${theme?'bg-sideBarLight':'bg-sideBarDark'} transition-all ${theme?'text-sideBarTextDark':'text-sideBarTextLight'} rounded-t-[12px] overflow-hidden`}>
              ...
              <button className={` w-[40px] flex justify-center items-center h-[40px]`} onClick={() => toggleInlineStyle('ITALIC')}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className={` w-[40px] flex justify-center items-center h-[40px]`} onClick={() => toggleInlineStyle('UNDERLINE')}>
              ...
              <button className={` w-[40px] flex justify-center items-center h-[40px]`} onClick={() => toggleInlineStyle('STRIKETHROUGH')}>
              ...
              <button className={` w-[40px] flex justify-center items-center h-[40px]`} onClick={() => toggleBlockType('blockquote')}>
              ...
              <button className={` w-[40px] flex justify-center items-center transition-all h-[40px]`} onClick={() => toggleBlockType('unordered-list-item')}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className={` w-[40px] flex justify-center items-center transition-all h-[40px]`} onClick={() => toggleBlockType('ordered-list-item')}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className={` w-[40px] flex justify-center items-center h-[40px]`} onClick={promptForLink}>
              ...
              <button className={` w-[40px] flex justify-center items-center h-[40px]`} onClick={removeLink}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className={` w-[40px] flex justify-center items-center h-[40px]`} onClick={() => fileInputRef.current.click()}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button onClick={() => toggleBlockTypes('header-six')} className={` w-[50px] h-[40px]`}>12px</button>
              <button onClick={() => toggleBlockTypes('header-five')} className={` w-[50px] h-[40px]`}>14px</button>
              <button onClick={() => toggleBlockTypes('header-four')} className={` w-[50px] h-[40px]`}>16px</button>
