    ...
    <div className='w-full h-auto'>
      ...
      <div className='w-full h-full px-[40px]'>
        ...
        <form >
          ...
          <textarea name="" id="description" placeholder='Enter asset description' onChange={(e) => setUrl(e.target.value)} required  className={`w-full outline-none border p-4 min-h-[250px] border-[#262E34] px-[15px] bg-bgMode transition-all text-textMode rounded-[12px]`}></textarea>
          </div>
        </form>
