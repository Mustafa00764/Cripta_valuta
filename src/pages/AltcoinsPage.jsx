   ...
   <div>
      ...
      <div className="flex mt-8 mb-8 sm:mt-6 sm:mb-6 mx:mt-4 mx:mb-4">
        ...
        <div className=' text-textMode w-full flex justify-end'>
          <div className='w-[91.5%] ml:w-full mt-8 sm:mt-6 mx:mt-4 flex bg-elementMode rounded-[15px] ml:pl-[52px] relative gap-[52px] md:pl-4 md:pr-4 md:pb-6 pt-[52px] ml:pt-[15vw] sm:pt-[10vw] ms:pt-[7vw] pb-[88px] pr-[52px] ml:flex-col'>
            ...
            <div className='w-full flex flex-col ml:items-center'>
              <h2 className='text-[36px] font-semibold leading-[48px] ms:ml-7 md:text-[24px] md:leading-[32px]'>Альткоины</h2>
              <p className='font-normal leading-6 max-w-[833px] w-full pr-5 mt-6  text-[16px] md:text-[14px] md:leading-5 mx:text-[12px] mx:leading-4 '>Альткоин (altcoin) — это любая криптовалюта или токен, кроме биткоина. Они могут иметь абсолютно разные функции (и даже не иметь никакой полезности, как в случае с мемкоинами). Например, совершенно разные криптовалюты, такие как Ethereum, Litecoin и XRP объединяет то, что все их можно называть альткоинами. Даже стейблкоин USDT могут обозначать как альткоин. Он работает на блокчейне и не является биткоином, а этого достаточно.</p>
            </div>
          </div>
        </div>
