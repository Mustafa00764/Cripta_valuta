      ...
      <div className="container">
        <div className="flex mt-9 mb-7 ">
          <button className="flex cursor-pointer items-center gap-1">
            ...
            <p className="text-[#779CFF]">Блокчейн</p>
          </button>
        </div>
        <div className='mt-[88px] text-textMode md:mt-[60px] sm:mt-[40px]'>
          <h2 className='text-[36px] font-semibold leading-[48px] md:text-[24px] md:leading-[32px]'>Блокчейн</h2>
          <p className='font-normal leading-6 max-w-[833px] w-full pr-5 mt-6  text-[16px] md:text-[14px] md:leading-5 mx:text-[12px] mx:leading-4'>Блокчейн – это технология децентрализованного хранения и распределенного внесения записей о транзакциях, основанная на криптографических методах защиты информации, позволяющая исключить посредника.</p>
        </div>
