      ...
      <div className="container">
        <div className="flex mt-9 mb-7 ">
          <button className="flex cursor-pointer items-center gap-1">
            ...
            <p className="text-[#779CFF]">P2E</p>
          </button>
        </div>
        <div className='mt-[88px] text-textMode md:mt-[60px] sm:mt-[40px]'>
          <h2 className='text-[36px] font-semibold leading-[48px] md:text-[24px] md:leading-[32px]'>P2E</h2>
          ...
          P2E-игры — проекты, где пользователь выполняет разные действия и получает за них виртуальную валюту. В отличие от кристаллов, звёздочек и прочих внутриигровых фантиков, эта валюта имеет ценность, так как работает на блокчейне и привязана к NFT (невзаимозаменяемому токену). Игроки получают эти токены за активность.</p>
        </div>
