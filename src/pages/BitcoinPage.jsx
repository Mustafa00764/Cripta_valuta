      ...
      <div className="container">
        <div className="flex mt-9 mb-7 ">
          <button className="flex cursor-pointer items-center gap-1">
            ...
            <p className="text-[#779CFF]">Биткоин</p>
          </button>
        </div>
        <div className='mt-[88px] text-textMode md:mt-[60px] sm:mt-[40px]'>
          ...
          <p className='font-normal leading-6 max-w-[833px] w-full pr-5 mt-6 text-[16px] md:text-[14px] md:leading-5 mx:text-[12px] mx:leading-4'>Биткоин (BTC) — первая и самая популярная криптовалюта в мире. По состоянию на начало апреля 2022 года, стоимость одного биткоина — около $44 тыс., а капитализация этой криптовалюты – чуть больше $850 трлн.</p>
        </div>
